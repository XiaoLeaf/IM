<template>
	<view class="root" :class="[type == 'logistics' ? 'pt50' : type == 'falshSale' ? 'pt0' : 'pt100']">
		<image webp="true" lazy-load="true" mode="widthFix" class="empty-img" src="@/static/images/empty_2.png"></image>
		<view class="empty-txt">{{ emptyText }}</view>
		<button v-if="showEmptyBtn" hover-class="none" @click="onClickEmptyBtn" :style="indexConfig.btnStyle.empty" class="empty-btn">去逛逛</button>
	</view>
</template>
